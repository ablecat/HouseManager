...
<body>
<div class="add">
    <form id="addForm" action="http://localhost:8080/untitled1_war_exploded/owner_users?method=register" target="_parent" method="post">
        <table class="tableadd" style="width: 50%;">
            ...
            <tr>
                <td>姓名</td>
                <td><input type="text" name="OName" value="zhangsan"></td>
            </tr>
            <tr>
                <td>地址</td>
                <td><input type="text" name="OAddress" value="qingdao"></td>
            </tr>
            <tr>
                <td>电话</td>
                <td><input type="text" name="OTelephone" value="10086"></td>
            </tr>
            <tr>
